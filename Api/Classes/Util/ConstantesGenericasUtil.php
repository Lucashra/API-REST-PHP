...
abstract class ConstantesGenericasUtil
{
    ...
    public const TIPO_GET = ['USUARIOS', 'CONTATO'];
    public const TIPO_POST = ['USUARIOS', 'CONTATO'];
    public const TIPO_DELETE = ['USUARIOS', 'CONTATO'];
    public const TIPO_PUT = ['USUARIOS', 'CONTATO'];
